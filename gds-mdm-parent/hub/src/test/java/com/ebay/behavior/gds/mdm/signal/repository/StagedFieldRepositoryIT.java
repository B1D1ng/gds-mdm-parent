...
class StagedFieldRepositoryIT {
    ...
    @Test
    void findByName() {
        var field1 = stagedField(signalId).toBuilder().name(term).build();
        var field2 = stagedField(signalId).toBuilder().name(term).build();
    ...
    void findByNameContaining() {
        var field1 = stagedField(signalId).toBuilder().name("prefix_" + term).build();
        var field2 = stagedField(signalId).toBuilder().name(term + "_suffix").build();
        repository.save(field1);
        repository.save(field2);
    ...
    void findByNameStartingWith() {
        var field1 = stagedField(signalId).toBuilder().name(term + "Signal1").build();
        var field2 = stagedField(signalId).toBuilder().name(term + "Signal2").build();
        repository.save(field1);
        repository.save(field2);
    ...
    @Test
    void findByTag() {
        var field1 = stagedField(signalId).toBuilder().tag(term).build();
        var field2 = stagedField(signalId).toBuilder().tag(term).build();
        repository.save(field1);
        repository.save(field2);
    ...
    void findByTagStartingWith() {
        var field1 = stagedField(signalId).toBuilder().tag(term + "Signal1").build();
        var field2 = stagedField(signalId).toBuilder().tag(term + "Signal2").build();
        repository.save(field1);
        repository.save(field2);
    ...
    void findByTagContaining() {
        var field1 = stagedField(signalId).toBuilder().tag("prefix_" + term).build();
        var field2 = stagedField(signalId).toBuilder().tag(term + "_suffix").build();
        repository.save(field1);
        repository.save(field2);
    ...
    void findByDescription() {
        var field1 = stagedField(signalId).toBuilder().description(term).build();
        var field2 = stagedField(signalId).toBuilder().description(term).build();
        repository.save(field1);
        repository.save(field2);
    ...
    void findByDescriptionStartingWith() {
        var field1 = stagedField(signalId).toBuilder().description(term + "_suffix1").build();
        var field2 = stagedField(signalId).toBuilder().description(term + "_suffix2").build();
        repository.save(field1);
        repository.save(field2);
    ...
    void findByDescriptionContaining() {
        var field1 = stagedField(signalId).toBuilder().description("prefix_" + term).build();
        var field2 = stagedField(signalId).toBuilder().description(term + "_suffix").build();
        repository.save(field1);
        repository.save(field2);
    ...
    @Test
    void findAllByIdIn() {
        var field1 = stagedField(signalId);
        var id = repository.save(field1).getId();
    ...
    @Test
    void findFieldIdsBySignalIds() {
        var field1 = stagedField(signalId);
        var id = repository.save(field1).getId();

        var result = repository.findFieldIdsBySignalIds(Set.of(signalId));
        ...
        assertThat(result).extracting("childId").contains(id);
    }
}