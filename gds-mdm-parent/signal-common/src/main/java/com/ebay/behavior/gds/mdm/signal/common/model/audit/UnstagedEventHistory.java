...
public class UnstagedEventHistory extends AbstractHistoryAuditable {
    ...
    @JsonIgnore
    public UnstagedEventHistory withOriginalId(Long id) {
        return this.toBuilder().originalId(id).build();
    }

    @JsonIgnore
    public UnstagedEventHistory withOriginalRevision(Integer revision) {
        return this.toBuilder().originalRevision(revision).build();
    }

    @JsonIgnore
    public UnstagedEventHistory withType(ChangeType changeType) {
