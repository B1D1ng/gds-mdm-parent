...
@Provider
@Component
public class UdcExceptionMapper extends AbstractExceptionMapper
        implements ExceptionMapper<UdcException> {

    private final long errorId = 20L;
    private final ErrorCategoryEnumV3 errorCategory = ErrorCategoryEnumV3.APPLICATION;

    @Override
    public Response toResponse(UdcException ex) {
