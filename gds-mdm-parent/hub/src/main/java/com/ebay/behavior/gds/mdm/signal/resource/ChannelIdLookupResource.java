...
@Validated
@Path(V1 + LOOKUP + "/channel_id")
@RestController
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public class ChannelIdLookupResource {
    ...
    @POST
    @Operation(summary = "Create a new channel id")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Create a new channel id"),
            @ApiResponse(responseCode = "400", description = "Bad request")
    })
    public Response create(ChannelIdLookup lookup) {
    ...
    @PUT
    @Path("/{id}")
    @Operation(summary = "Update existing channel id")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Updated the channel id",
                    content = {@Content(schema = @Schema(implementation = ChannelIdLookup.class))}),
            @ApiResponse(responseCode = "400", description = "Bad request",
                    content = {@Content(schema = @Schema(implementation = ErrorMessageV3.class))}),
            @ApiResponse(responseCode = "417", description = "Id not found",
                    content = {@Content(schema = @Schema(implementation = ErrorMessageV3.class))})
    })
    public Response update(@PathParam(ID) Long id, ChannelIdLookup lookup) {
    ...
    @GET
    @Operation(summary = "Search channel id")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Get all channel id",
                    content = {@Content(schema = @Schema(implementation = ChannelIdLookup.class))}),
            @ApiResponse(responseCode = "400", description = "Bad request",
                    content = {@Content(schema = @Schema(implementation = ErrorMessageV3.class))})
    })
    ...
    @GET
    @Path("/{id}")
    @Operation(summary = "Get channel id by id")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Get channel id by id",
                    content = {@Content(schema = @Schema(implementation = ChannelIdLookup.class))}),
            @ApiResponse(responseCode = "400", description = "Bad request",
                    content = {@Content(schema = @Schema(implementation = ErrorMessageV3.class))})
    })
